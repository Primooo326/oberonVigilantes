(self["webpackChunkOberonVIP"] = self["webpackChunkOberonVIP"] || []).push([["common"],{
...
let LoadingService = class LoadingService {
    constructor(loadingController) {
        ...
        this.m_IDModulo = "TGSI_THMALPI_PAN";
        this.m_UsuarioApp = "OBALPITHM";
        this.m_PasswordApp = "DsSJyz/sPzurKMw3jzqFZKhg/BbhwCbj0ykiJGBQQz0=";
        this.m_CodigoWSApp = "TGSI_THMALPI_PAN";
        this.m_IMEI = "";
        this.m_UrlWS = "https://alpicovid.azurewebsites.net/vip/WsAlpina.asmx";
        this.m_Nombres = "";
        this.m_Cargo = "";
